    ...
    <>
      <div className="bg-gradient-to-b from-[#9C9CFF] to-[#FFFADA]">
        ...
        <div className="flex justify-center items-center py-20">
          <a href="/documents/Pembagian-Kelompok-Inisiasi-FTI-2024.pdf" target="_blank" download className="p-5 border-2 border-[#9C9CFF] rounded-full font-sinerva text-xl font-bold bg-[#6868C8] text-white">CEK PEMBAGIAN KELOMPOK</a>
        </div>
